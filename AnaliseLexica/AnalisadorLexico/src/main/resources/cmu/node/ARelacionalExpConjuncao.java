...
public final class ARelacionalExpConjuncao extends PExpConjuncao
{
    private PExpRelacional _expRelacional_;

    public ARelacionalExpConjuncao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ARelacionalExpConjuncao(
    ...
    {
        ((Analysis) sw).caseARelacionalExpConjuncao(this);
    }

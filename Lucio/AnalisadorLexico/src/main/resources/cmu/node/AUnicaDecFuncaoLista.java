...
public final class AUnicaDecFuncaoLista extends PDecFuncaoLista
{
    private PDecFuncao _decFuncao_;

    public AUnicaDecFuncaoLista()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AUnicaDecFuncaoLista(
    ...
    {
        ((Analysis) sw).caseAUnicaDecFuncaoLista(this);
    }
